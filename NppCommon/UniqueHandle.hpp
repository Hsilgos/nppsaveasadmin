...
class UniqueHandle final {
 public:
  ...
  UniqueHandle(UniqueHandle&& that)
      : m_handle(that.release()), m_handle_closer(that.m_handle_closer) {
    that.release();
  }
  ...
  UniqueHandle(HANDLE handle, HandleCloser handle_closer = &CloseHandle)
      : m_handle(handle), m_handle_closer(handle_closer) {}
